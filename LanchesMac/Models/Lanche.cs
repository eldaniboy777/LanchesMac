...
namespace LanchesMac.Models
{
    ...
    public class Lanche
    {
        ...
        [StringLength(80, MinimumLength = 1, ErrorMessage = "O {0} deve ter no mínimo {1} e no máximo {2} caracteres")]
        ...
        [MinLength(1, ErrorMessage = "Descrição detalhada deve ter no mínimo {1} caracteres")]
